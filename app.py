...
if ENV == 'dev':
    ...
    app.debug = False
    app.config['SQLALCHEMY_DATABASE_URI'] = 'postgres://iujcxtsmobpqkh:afd4a0fd46be33a999e04833539030320484d5d7a36f053cad6521d7c2f5869c@ec2-34-237-89-96.compute-1.amazonaws.com:5432/d6ebh12r1chp2s'
